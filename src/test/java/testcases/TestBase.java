...
public class TestBase {
    ...
    public void defineSuiteElements() {
        ...
        // initialize test
        test = extent.createTest("Airbnb-Project"+" Test Automation Project");

        //configuration items to change the look and fee add content, manage tests etc
        htmlReporter.config().setDocumentTitle("Airbnb-Project"+" Test Automation Report");
        htmlReporter.config().setReportName("Airbnb-Project"+" Test Report");
